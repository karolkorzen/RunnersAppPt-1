...
class EditProfileCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        bioTextView.anchor(top: topAnchor, left: titleLabel.rightAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 4, paddingLeft: 11, paddingRight: 8)
    }
    ...
    func configure(){
        ...
        infoTextField.addTarget(self, action: #selector(handleUpdateUserInfo), for: .editingChanged)
