...
class LoginController: UIViewController {
    ...
    private let logoImageView: UIImageView = {
        ...
        iv.image = #imageLiteral(resourceName: "running_logo")
        return iv
    }()
    ...
    func configureUI(){
        ...
        stack.anchor(top: logoImageView.bottomAnchor , left: view.leftAnchor, right: view.rightAnchor, paddingTop: 10, paddingLeft: 32, paddingRight: 32)
